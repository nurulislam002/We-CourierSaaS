            ...
            Route::group(['middleware' => 'auth'], function () {
                ...
                Route::group(['middleware' => ['subscriptionCheck', 'XSS']], function () {
                    ...
                    Route::group(['prefix' => 'admin'], function () {
                        ...
                        Route::get('payment-gateway/create', [PaymentGatewayController::class, 'create'])->name('payment-gateway.create');
                        Route::post('payment-gateway/store', [PaymentGatewayController::class, 'store'])->name('payment-gateway.store');
                        Route::get('payment-gateway/edit', [PaymentGatewayController::class, 'edit'])->name('payment-gateway.edit');
                        Route::put('payment-gateway/update', [PaymentGatewayController::class, 'update'])->name('payment-gateway.update');
                        Route::delete('payment-gateway/destroy', [PaymentGatewayController::class, 'destroy'])->name('payment-gateway.destroy');
                        Route::get('payment-gateway/filter', [PaymentGatewayController::class, 'filter'])->name('payment-gateway.filter');
