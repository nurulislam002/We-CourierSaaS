                ...
                <div class="nav-left-sidebar sidebar-dark navbar-expand-lg ">
                    <ul class="navbar-nav">
                        ...
                        @if (hasPermission('hub_read') == true || hasPermission('hub_payment_read') == true)
                            <li class="nav-item">
                                <a class="nav-link {{ request()->is('admin/hubs*', 'admin/request/hub/payment*', 'admin/hub/incharge*', 'admin/hub/view*','admin/hub/map/show*') ? 'active' : '' }}"
                                ...
                                <div id="hub-manage"
                                    class="{{ request()->is('admin/hubs*', 'admin/request/hub/payment*', 'admin/hub/incharge*', 'admin/hub/view*','admin/hub/map/show*') ? '' : 'collapse' }} submenu">
                        ...
                        @if (hasPermission('payment_read') == true)
                            <li class="nav-item ">
                                <a class="nav-link {{ request()->is('admin/payment-gateway*') ? 'active' : '' }}"
                                    href="{{ route('payment-gateway.index') }}" aria-expanded="false" data-target="#payment-gateway" aria-controls="payment-gateway"><i
                                        class="fas fa-piggy-bank"></i>{{ __('menus.payment-gateway') }}</a>
                            </li>
                        @endif
