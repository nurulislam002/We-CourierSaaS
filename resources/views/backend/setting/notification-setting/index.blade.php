                        ...
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="fcm_secret_key" type="text" name="fcm_secret_key" data-parsley-trigger="change" placeholder="{{ __('placeholder.Enter_fcm_secret_key') }}" autocomplete="off" class="form-control @error('fcm_secret_key') is-invalid @enderror" value="{{old('fcm_secret_key',$settings->fcm_secret_key ?? '') }}" require>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="fcm_topic" type="text" name="fcm_topic" data-parsley-trigger="change" placeholder="{{ __('placeholder.Enter_fcm_topic') }}" autocomplete="off" class="form-control @error('fcm_topic') is-invalid @enderror" value="{{ old('fcm_topic',$settings->fcm_topic ?? '') }}" require>
                                    @error('fcm_topic')
                                        <small class="text-danger mt-2">{{ $message }}</small>
                                    @enderror
                                </div>
