                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <div class="form-group" id="bank">
                                    ...
                                    <select name="bank" class="form-control">
                                        @foreach ($payment_gateways as $gateway)
                                            @if ($gateway->type == App\Enums\PaymentType::BANK)
                                                <option value="{{$gateway->name }}"
                                                    {{ old('bank', $account->bank ?? null) === $gateway->name ? 'selected' : '' }}
                                                    >{{$gateway->name }}</option>
                                            @endif
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group" id="mobile_bank">
                                    <label for="mobile_bank">{{ __('levels.mobile_bank') }}</label> <span class="text-danger">*</span>
                                    <select name="mobile_bank" class="form-control">
                                        @foreach ($payment_gateways as $gateway)
                                            @if ($gateway->type == App\Enums\PaymentType::MOBILE)
                                                <option value="{{$gateway->name }}"
                                                    {{ old('mobile_bank', $account->mobile_bank ?? null) === $gateway->name ? 'selected' : '' }}
                                                    >{{$gateway->name }}</option>
                                            @endif
                                        @endforeach
                                    </select>
